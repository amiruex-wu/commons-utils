...
public class NumberUtils1 {
     ...
     */
    public static final Float FLOAT_ZERO = Float.valueOf("0.0");
    /**
     ...
     */
    public static final Float FLOAT_MINUS_ONE = Float.valueOf("-1.0");
     ...
     *
     * <pre>
     *   NumberUtils.toIntIfNull(null, 1) = 1
     *   NumberUtils.toIntIfNull("", 1)   = 1
     *   NumberUtils.toIntIfNull("1", 0)  = 1
     * </pre>
     *
     * @param str          the string to convert, may be null
     ...
     */
    public static int toIntIfNull(final String str, final int defaultValue) {
    ...
    public static int toIntIfNull(final Integer integer, final int defaultValue) {
    ...
    /**
     * <p>Convert a {@code String} to an {@code Integer}, returning
     * {@code null} if the conversion fails.</p>
     *
     * <p>If the string is {@code null}, {@code null} is returned.</p>
     *
     * <pre>
     *   NumberUtils.toInteger(null) = null
     *   NumberUtils.toInteger("")   = null
     *   NumberUtils.toInteger("1")  = 1
     * </pre>
     *
     * @param str the string to convert, may be null
     * @return the Integer represented by the string, or {@code null} if
     * conversion fails
     */
    public static Optional<Integer> toInteger(final String str) {
        return toIntegerIfNull(str, null);
    }

    /**
     * <p>Convert a {@code String} to an {@code Integer}, returning a
     * default value if the conversion fails.</p>
     *
     * <p>If the string is {@code null}, the default value is returned.</p>
     *
     * <pre>
     *   NumberUtils.toIntegerIfNull(null, null) = null
     *   NumberUtils.toIntegerIfNull(null, 1)    = 1
     *   NumberUtils.toIntegerIfNull("", 1)      = 1
     *   NumberUtils.toIntegerIfNull("1", 0)     = 1
     * </pre>
     *
     * @param str          the string to convert, may be null
     * @param defaultValue the default value
     * @return the int represented by the string, or the default if conversion fails
     */
    public static Optional<Integer> toIntegerIfNull(final String str, final Integer defaultValue) {
        if (StringUtils.isBlank(str)) {
     ...
     *
     * <pre>
     *   NumberUtils.toLongIfNull(null, 1L) = 1L
     *   NumberUtils.toLongIfNull("", 1L)   = 1L
     *   NumberUtils.toLongIfNull("1", 0L)  = 1L
     * </pre>
     *
     * @param str          the string to convert, may be null
     * @param defaultValue the default value
     ...
     */
    public static long toLongIfNull(final String str, final long defaultValue) {
        if (StringUtils.isBlank(str)) {
            return defaultValue;
        }
        try {
     ...
     * if conversion fails
     */
    public static float toFloatIfNull(final String str, final float defaultValue) {
        if (StringUtils.isBlank(str)) {
            return defaultValue;
        }
        try {
    ...
    public static double toDouble(final String str) {
        return toDoubleIfNull(str, 0.0d);
    }
     ...
     *
     * <pre>
     *   NumberUtils.toDoubleIfNull(null, 1.1d)   = 1.1d
     *   NumberUtils.toDoubleIfNull("", 1.1d)     = 1.1d
     *   NumberUtils.toDoubleIfNull("1.5", 0.0d)  = 1.5d
     * </pre>
     *
     * @param str          the string to convert, may be {@code null}
     * @param defaultValue the default value
     ...
     * if conversion fails
     */
    public static double toDoubleIfNull(final String str, final double defaultValue) {
        if (StringUtils.isBlank(str)) {
            return defaultValue;
        }
        try {
    ...
    public static double toDouble(final BigDecimal value) {
        return toDoubleIfNull(value, 0.0d);
    }
     ...
     * <pre>
     *   NumberUtils.toDoubleIfNull(null, 1.1d)                     = 1.1d
     *   NumberUtils.toDoubleIfNull(BigDecimal.valudOf(8.5d), 1.1d) = 8.5d
     * </pre>
     *
     * @param value        the {@code BigDecimal} to convert, may be {@code null}.
     * @param defaultValue the default value
     ...
     */
    public static double toDoubleIfNull(final BigDecimal value, final double defaultValue) {
        return ObjectUtils.isNull(value) ? defaultValue : value.doubleValue();
    }
    ...
    public static byte toByte(final String str) {
        return toByteIfNull(str, (byte) 0);
    }
     ...
     *
     * <pre>
     *   NumberUtils.toByteIfNull(null, 1) = 1
     *   NumberUtils.toByteIfNull("", 1)   = 1
     *   NumberUtils.toByteIfNull("1", 0)  = 1
     * </pre>
     *
     * @param str          the string to convert, may be null
     * @param defaultValue the default value
     ...
     */
    public static byte toByteIfNull(final String str, final byte defaultValue) {
        if (StringUtils.isBlank(str)) {
            return defaultValue;
        }
        try {
    ...
    public static short toShort(final String str) {
        return toShortIfNull(str, (short) 0);
    }
     ...
     *
     * <pre>
     *   NumberUtils.toShortIfNull(null, 1) = 1
     *   NumberUtils.toShortIfNull("", 1)   = 1
     *   NumberUtils.toShortIfNull("1", 0)  = 1
     * </pre>
     *
     * @param str          the string to convert, may be null
     * @param defaultValue the default value
     ...
     */
    public static short toShortIfNull(final String str, final short defaultValue) {
        if (StringUtils.isBlank(str)) {
            return defaultValue;
        }
        try {
     ...
     * @throws IllegalArgumentException if {@code array} is {@code null}
     * @throws IllegalArgumentException if {@code array} is empty
     * @see #min(double[]) IEEE754rUtils for a version of this method that handles NaN differently
     */
     ...
     * @throws IllegalArgumentException if {@code array} is {@code null}
     * @throws IllegalArgumentException if {@code array} is empty
     * @see #min(float[]) IEEE754rUtils for a version of this method that handles NaN differently
     */
     ...
     * @throws IllegalArgumentException if {@code array} is {@code null}
     * @throws IllegalArgumentException if {@code array} is empty
     * @see #max(double[]) IEEE754rUtils for a version of this method that handles NaN differently
     */
     ...
     * @throws IllegalArgumentException if {@code array} is {@code null}
     * @throws IllegalArgumentException if {@code array} is empty
     * @see #max(float[]) IEEE754rUtils for a version of this method that handles NaN differently
     */
     ...
     * @param c value 3
     * @return the smallest of the values
     * @see #min(double, double, double) for a version of this method that handles NaN differently
     */
     ...
     * @param c value 3
     * @return the smallest of the values
     * @see #min(float, float, float) for a version of this method that handles NaN differently
     */
     ...
     * @param c value 3
     * @return the largest of the values
     * @see #max(double, double, double) for a version of this method that handles NaN differently
     */
     ...
     * @param c value 3
     * @return the largest of the values
     * @see #max(float, float, float) for a version of this method that handles NaN differently
     */
     ...
     * use {@link NumberUtils1#isCreatable(String)} instead
     */
    @Deprecated
