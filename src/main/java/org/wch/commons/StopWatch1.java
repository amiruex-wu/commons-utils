...
public class StopWatch1 {
    ...
    private final List<StopWatch1.TaskInfo> taskList;
    private long startTimeNanos;
    private String currentTaskName;
    private StopWatch1.TaskInfo lastTaskInfo;
     ...
     * @return StopWatch a stopwatch.
     */
    public static StopWatch1 create(String id) {
        return new StopWatch1(id);
    }
    ...
    public static StopWatch1 createStarted() {
        final StopWatch1 sw = new StopWatch1();
        sw.start();
        return sw;
    }
     ...
     * @return StopWatch a stopwatch that's already been started.
     */
    public static StopWatch1 createStarted(String taskName) {
        final StopWatch1 sw = new StopWatch1();
        sw.start(taskName);
        return sw;
    }
    ...
    public void stop() throws IllegalStateException {
        if (ObjectUtils.isNull(this.currentTaskName)) {
            ...
            this.lastTaskInfo = new StopWatch1.TaskInfo(this.currentTaskName, lastTime);
...
//            throw new IllegalStateException("No tasks run: can't get last task name");
    ...
    public Optional<StopWatch1.TaskInfo> getLastTaskInfo() throws IllegalStateException {
        if (ObjectUtils.isNull(this.lastTaskInfo)) {
//            throw new IllegalStateException("No tasks run: can't get last task info");
    ...
    public StopWatch1.TaskInfo[] getTaskInfo() {
        if (!this.keepTaskList) {
    ...
    public String prettyPrint() {
        ...
        if (!this.keepTaskList) {
            ...
            StopWatch1.TaskInfo[] taskInfos = this.getTaskInfo();
    ...
    public static final class TaskInfo {
        ...
        public long getTimeMillis() {
            return StopWatch1.nanosToMillis(this.timeNanos);
        }

        public double getTimeSeconds() {
            return StopWatch1.nanosToSeconds(this.timeNanos);
        }
    }
}
