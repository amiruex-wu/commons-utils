...
import top.itoolbox.commons.enums.JavaVersion;
import top.itoolbox.commons.enums.OperateSystemType;
...
public class SystemUtils {
    ...
    /**
     *  Gets the host operate system type from an environment variable
     * @return the host name. Will be {@code null} if the environment variable is not defined.
     */
    public static Optional<OperateSystemType> getHostOS() {
//        String os = System.getProperty("os.name");
        // Windows操作系统
        if (OS_NAME != null && OS_NAME.toLowerCase().startsWith("windows")) {
//            System.out.printf("当前系统版本是:%s%n", OS_NAME);
            return Optional.of(OperateSystemType.WINDOWS);
        } else if (OS_NAME != null && OS_NAME.toLowerCase().startsWith("linux")) {
            //Linux操作系统
//            System.out.printf("当前系统版本是:%s%n", OS_NAME);
            return Optional.of(OperateSystemType.LINUX);
        } else {
            //其它操作系统
//            System.out.printf("当前系统版本是:%s%n", OS_NAME);
            return Optional.of(OperateSystemType.OTHER);
        }
    }
