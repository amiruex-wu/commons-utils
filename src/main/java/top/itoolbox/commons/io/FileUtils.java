package top.itoolbox.commons.io;


import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import top.itoolbox.commons.callableInterface.FileReaderCallable;
import top.itoolbox.commons.callableInterface.FileWriterCallable;
    ...
    public static void copyFolder(Path sourcePath, Path destinationPath) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Folder copied successfully.");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
